...
app.post("/register/", async (request, response) =>{
    ...
    const userDetails - await db,await db.get(getUserQuery);
...
app.get(
    "/tweets/:tweetId/likes/", authentication, tweetAccessVerification,async (request, response)=>{
        const {tweetId} = request.params;
        const getLikedQuery = `SELECT username 
...
app.get(
    "/tweets/:tweetId/replies/", authentication, tweetAccessVerification,async (request, response)=>{
        const {tweetId} = request.params;
